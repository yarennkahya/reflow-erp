...
urlpatterns = [
    ...
    path('customers/new/', views.customer_create_view, name='customer-create'),
    path('customers/<int:pk>/edit/', views.customer_edit_view, name='customer-edit'),
    ...
    path('orders/<int:pk>/set-status/', views.order_set_status_view,
