...
urlpatterns = [
    ...
    path('recruitment/candidates/', views.candidates_pool_view, name='hr-candidates'),
    path('recruitment/candidates/new/', views.candidate_create_view, name='candidate-create'),
    path('recruitment/candidates/<int:pk>/', views.candidate_detail_view, name='hr-candidate-detail'),
    path('recruitment/candidates/<int:pk>/upload/', views.candidate_document_upload_view, name='candidate-doc-upload'),
